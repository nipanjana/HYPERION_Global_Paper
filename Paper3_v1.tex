...
\begin{enumerate}
\item
1. Details of all-sky model generation: GSM, GMOSS, Avery-Adrian: 
\item
2.References to all the papers.
\item
3.pros and cons of each model.
\item
4. Three different sky models as image.
\item
5. Present HYPERION beam and the beam model and justify.
\end{enumerate}
